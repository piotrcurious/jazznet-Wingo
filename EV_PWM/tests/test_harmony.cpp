...
void test_harmonic_entrainment() {
    ...
    updateEnsemblePeer(mac1, 0, 100, 0, 0, 0.0, 0.0, 0, false, 0, 0, 0); // ii
    updateEnsemblePeer(mac2, 1, 100, 0, 0, 0.0, 0.0, 0, false, 0, 0, 0); // V
    ...
    for(int i=0; i<1000; i++) {
        ...
        updateEnsemblePeer(mac1, 0, 100, 0, 0, 0.0, 0.0, 0, false, 0, 0, 0);
        updateEnsemblePeer(mac2, 1, 100, 0, 0, 0.0, 0.0, 0, false, 0, 0, 0);
...
void test_leadership_weighting() {
    ...
    uint8_t mac1[6] = {0x1, 0, 0, 0, 0, 1};
    updateEnsemblePeer(mac1, 3, 30, 0, 0, 0.0, 0.0, 0, false, 0, 0, 0);

    // Peer 2: High intensity (LEADER), wants chord vi (idx 4)
    uint8_t mac2[6] = {0x2, 0, 0, 0, 0, 2};
    updateEnsemblePeer(mac2, 4, 120, 0, 0, 0.0, 0.0, 0, false, 0, 0, 0);
