...
void test_ensemble_logic() {
    ...
    updateEnsemblePeer(peerMac, 1, 127, 127, 60); // Peer playing V chord at max intensity/dissonance
...
void test_peer_timeout() {
    ...
    updateEnsemblePeer(peerMac, 1, 100, 0, 0);
...
void test_invalid_peer_data() {
    ...
    updateEnsemblePeer(peerMac, 99, 100, 0, 0); // Invalid chord index
